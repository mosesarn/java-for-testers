...
public class ExceptionHandlingExercises{
    ...
    public void workingWithDeclaredExceptions() throws IOException {
        ...
        assertThat(fileLoader.readHelloWorld("hello.txt")).isEqualTo("Hello World");
    }
    ...
    public void catchingExceptions()throws Exception,MissingWelcomeFileException {
     ...
     */
    @Test(expected = MissingWelcomeFileException.class)
    public void catchingCustomExceptionsWhenTheFileDoesNotExist() throws Exception,MissingWelcomeFileException {
        //FileLoader fileLoader = new FileLoader();
        assertThat(fileLoader.fileHasText("does-not-exist.txt", "Hello World")).isFalse();
    }
